...
\pagestyle{fancy}
\fancyhf{}
\rhead{\small HEAR-WORK AI}
\lhead{\small Stress, Tinnitus, and Hearing Outcomes}
\cfoot{\thepage}
\renewcommand{\headrulewidth}{0.4pt}

\title{HEAR-WORK AI: Public-Data Development and External Validation of an Explainable Framework for Occupational Stress, Tinnitus, and Hearing Outcomes}
