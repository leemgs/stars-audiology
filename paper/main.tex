...
\small
\begin{tabular}{ll}
\textbf{Article type:} & Study Protocol / Pre-Analysis Plan (no empirical results) \\
...
\textbf{Empirical findings:} & None reported; all quantitative values are synthetic scaffold checks \\
