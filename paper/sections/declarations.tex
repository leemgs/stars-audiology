...
\textbf{Protocol Status and Registration:} This is a pre-analysis study protocol with a preliminary NHANES demonstration; the primary KNHANES perceived-stress analyses are not yet reported. The prespecified analysis plan (cycles, variables, adjustment sets, endpoints, and metrics) is time-stamped in the versioned repository, and public registration of the plan is intended prior to the primary KNHANES analysis.
...
\textbf{Code Availability:} All analysis code, configuration, model cards, prompt templates, and the reporting checklist are openly available at \url{https://github.com/leemgs/stars-audiology} under an open-source license.
