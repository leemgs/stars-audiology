...
\textbf{Code Availability:} All analysis code, configuration, model cards, prompt templates, and the reporting checklist are openly available at \url{https://github.com/leemgs/stress-ear-ai} under an open-source license.
